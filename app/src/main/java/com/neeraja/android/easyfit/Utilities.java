...
public class Utilities {
    ...
    static public int today_flowerimage (int flag){
        int flowerImage;
        switch (flag) {
            case 0: flowerImage = R.drawable.r0;break;
            case 1: flowerImage = R.drawable.r1;break;
            case 2: flowerImage = R.drawable.r2;break;
            case 3: flowerImage = R.drawable.r3;break;
            case 4: flowerImage = R.drawable.r4;break;
            case 5: flowerImage = R.drawable.r5;break;
            case 6: flowerImage = R.drawable.r6;break;
            case 7: flowerImage = R.drawable.r7;break;
           // case 8: flowerImage = R.drawable.r7;break;


            default: flowerImage =R.drawable.r7;
        }
        return flowerImage;
    }
