...
import com.fourseasons.neeraja.fourseasons.BuildConfig;
import com.fourseasons.neeraja.fourseasons.MainActivity;
import com.fourseasons.neeraja.fourseasons.R;
import com.fourseasons.neeraja.fourseasons.Utility;
import com.fourseasons.neeraja.fourseasons.data.WeatherContract;
import com.fourseasons.neeraja.fourseasons.muzei.WeatherMuzeiSource;
...
public class EasyfitnessSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = EasyfitnessSyncAdapter.class.getSimpleName();
    public static final String ACTION_DATA_UPDATED =
            "com.fourseasons.neeraja.fourseasons.ACTION_DATA_UPDATED";
    ...
    public EasyfitnessSyncAdapter(Context context, boolean autoInitialize) {
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        EasyfitnessSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
